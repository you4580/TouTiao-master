...
/**
 * Created by sujian on 2016/10/11.
 */
public class NewTopLayout extends RelativeLayout{
    ...
    public NewTopLayout(Context context) {
        super(context);
    }

    public NewTopLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public NewTopLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public NewTopLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
