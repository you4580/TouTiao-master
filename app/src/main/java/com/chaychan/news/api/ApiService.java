...
import static com.chaychan.news.api.API.PHOTOGRAPH_LIST_URL;
import static com.chaychan.news.api.API.PHOTO_LIST_URL;
...
public interface ApiService {
     ...
     * @return
     */
    @GET(PHOTOGRAPH_LIST_URL)
    Observable<String> getPhotographList(@Query("page") String page);
     ...
     */
    @GET(PHOTO_LIST_URL)
    Observable<String> getPhotographList(@Query("bbs") String bbs,@Query("boardid") String boardid,@Query("bookid") String bookid,@Query("size") String size);
